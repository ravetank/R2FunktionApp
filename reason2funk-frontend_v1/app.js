...
async function loadProject(projectId) {
    ...
    try {
        ...
        console.log('Project loaded successfully:', project); // Debug log

        currentProjectName.textContent = project.name; // Update UI
        currentProjectId = project._id; // Store current project ID
        renderTasks(project.tasks); // Render tasks
        taskSection.style.display = 'block'; // Show task section
    } catch (error) {
        console.error('Error loading project:', error); // Log error
